...
if (isset($_POST['submitRatingStar'])) {
    ...
    $res=mysqli_query($conn, "SELECT email_user FROM curso_colas WHERE email_user='$correo'");
    $cantidad=mysqli_num_rows($res);
    if ($cantidad==1) {
        header("location: dashboard.php");
    }else{        
        $res=mysqli_query($conn, "INSERT INTO curso_colas (star_rate, email_user) VALUES ('$calif','$correo')");
        header("location: dashboard.php");
    }
}
?>
...
<head>
    ...
    <title class="challege">Challenge</title>
</head>
<script>
...
<body>
    ...
    <main>
        <h3 class="title">¿Cuáles son las funciones cola</h3>
        <form action="#" class="form">
            <nav>
                <table class="cuest">
                    <button id="a" ><tr onclick="Eva(true);">
                        <td class="opcion" >A</td>
                        <td class="answer" id="ansa">Poder acceder a los datos de una cola por uno de los dos extremos</td>
                    </tr>
                    <tr onclick="Eva(false);">
                        <td class="opcion">B</td>
                        <td class="answer" id="ansb">Poder acceder a los datos de una cola por uno de los extremos</td>
                    </tr>
                    <tr onclick="Eva(false);">
                        <td class="opcion">C</td>
                        <td class="answer" id="ansc">Poder acceder a los datos de una cola por el final de la estructura</td>
                    </tr>
                </table>
            </nav>
        </form> 
    ...
    <footer class="footer">
            <div class="row">
                <div id="content" class="col-lg-12">
                    <form action="ColasCuest.php" method="post">
                    <h6 id="text">Por favor califica del 1 al 5 que tal pareció este curso</h6>
